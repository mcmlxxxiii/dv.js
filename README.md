**dv.js** _(Dynamic Value)_ is a tiny library for reactive programming with javascript inspired by [the post][1] on that subject in [Silk's Engineering Blog][2].
